...
CREATE TABLE `library` (
  ...
  `category` enum('Any','Fiction','Non-Fiction','Adult','Reference','Religion','Kindred','Lupine','Kuei-Jin') NOT NULL, /* DARKPACK EDIT, ORIGINAL: `category` enum('Any','Fiction','Non-Fiction','Adult','Reference','Religion') NOT NULL, */
