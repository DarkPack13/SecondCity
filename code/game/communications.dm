...
GLOBAL_LIST_INIT(default_radio_channels, list(
	...
	RADIO_CHANNEL_POLICE = FREQ_POLICE,
	RADIO_CHANNEL_CLINIC = FREQ_CLINIC,
	RADIO_CHANNEL_MILITARY = FREQ_MILITARY,
	RADIO_CHANNEL_CAMARILLA = FREQ_CAMARILLA,
	RADIO_CHANNEL_ANARCH = FREQ_ANARCH,
