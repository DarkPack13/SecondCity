...
/datum/feed_network/New()
	#warn reflavor
	create_feed_channel(NEWSCASTER_STATION_ANNOUNCEMENTS, "SS13", "Company news, staff announcements, and all the latest information. Have a secure shift!", locked = TRUE) // DARKPACK EDIT CHANGE
