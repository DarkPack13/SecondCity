...
/obj/item/stack/rods/Initialize(mapload, new_amount, merge = TRUE, list/mat_override=null, mat_amt=1)
	...
	var/static/list/slapcraft_recipe_list = list(/datum/crafting_recipe/spear, /datum/crafting_recipe/stunprod, /* /datum/crafting_recipe/teleprod*/) // snatcher prod isn't here as a spoopy secret // DARKPACK EDIT REMOVAL
