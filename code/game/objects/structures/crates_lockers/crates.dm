...
/*	new /obj/item/reagent_containers/blood/lizard(src) // DARKPACK EDIT REMOVE START
	new /obj/item/reagent_containers/blood/ethereal(src)*/ // DARKPACK EDIT REMOVE END
	for(var/i in 1 to 3)
