...
GLOBAL_LIST_INIT(available_ui_styles, list(
	"World of Darkness New" = 'modular_darkpack/master_files/icons/hud/screen_darkness_new.dmi', // DARKPACK EDIT ADD - Put at the top because it has almost full coverage now!
	"Pentex-Knox" = 'modular_darkpack/master_files/icons/hud/screen_pentexknox.dmi', // DARKPACK EDIT CHANGE - Replaced the NT logo with a Pentex logo
