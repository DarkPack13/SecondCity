...
#define DEFIB_FAIL_STAKED (1<<12) // DARKPACK EDIT ADD
...
// #define YAWN_PROPAGATION_EXAMINE_WINDOW (2 SECONDS) DARKPACK EDIT REMOVAL - Yawning No Longer Spreads to Bystanders
...
#define CAN_SUCCUMB(target) (((target.stat == SOFT_CRIT || target.stat == HARD_CRIT) || HAS_TRAIT(target, TRAIT_DEATHCOMA)) && !HAS_TRAIT(target, TRAIT_NODEATH)) // DARKPACK EDIT CHANGE - Torpor
