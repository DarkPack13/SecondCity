...
///from base of /datum/storyteller_roll/proc/st_roll(): (mob/living/roller, datum/storyteller_roll/roll_datum, atom/target, atom/using_item, bonus, difficulty)
#define COMSIG_LIVING_PRE_DICE_ROLLED "living_pre_dice_rolled"
///from base of /datum/storyteller_roll/proc/st_roll(): (mob/living/roller, datum/storyteller_roll/roll_datum, atom/target, atom/using_item, output)
