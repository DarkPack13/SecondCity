...
GLOBAL_LIST_INIT(admin_visible_traits, list(
	...
	/mob = list(
		...
		"TRAIT_OPEN_WOUND_CHEST" = TRAIT_OPEN_WOUND_CHEST, // DARKPACK EDIT ADD - MERITS_FLAWS - Physical Flaw - Open Wound
		"TRAIT_OPEN_WOUND_FACE" = TRAIT_OPEN_WOUND_FACE, // DARKPACK EDIT ADD - MERITS_FLAWS - Physical Flaw - Open Wound
