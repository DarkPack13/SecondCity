...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_BLOOD_DRINKER" = TRAIT_BLOOD_DRINKER,
		...
		"TRAIT_CAN_ENTER_TORPOR" = TRAIT_CAN_ENTER_TORPOR,
		...
		"TRAIT_CANNOT_RESIST_MIND_CONTROL" = TRAIT_CANNOT_RESIST_MIND_CONTROL,
		...
		"TRAIT_CONSENSUAL_FEEDING_ONLY" = TRAIT_CONSENSUAL_FEEDING_ONLY,
		...
		"TRAIT_DEFICIENT_VITAE" = TRAIT_DEFICIENT_VITAE,
		...
		"TRAIT_FEEDING_RESTRICTION" = TRAIT_FEEDING_RESTRICTION,
		...
		"TRAIT_IRRESISTIBLE_VITAE" = TRAIT_IRRESISTIBLE_VITAE,
		...
		"TRAIT_LONGER_FRENZY" = TRAIT_LONGER_FRENZY,
		...
		"TRAIT_MASQUERADE_VIOLATING_EYES" = TRAIT_MASQUERADE_VIOLATING_EYES,
		"TRAIT_MASQUERADE_VIOLATING_FACE" = TRAIT_MASQUERADE_VIOLATING_FACE,
		...
		"TRAIT_PAINFUL_VAMPIRE_KISS" = TRAIT_PAINFUL_VAMPIRE_KISS,
		...
		"TRAIT_REJECTED_BY_TECHNOLOGY" = TRAIT_REJECTED_BY_TECHNOLOGY,
		"TRAIT_RELAYING_ATTACKER" = TRAIT_RELAYING_ATTACKER,
		"TRAIT_REMOTE_TASTING" = TRAIT_REMOTE_TASTING,
		"TRAIT_REPELLED_BY_HOLINESS" = TRAIT_REPELLED_BY_HOLINESS,
		...
		"TRAIT_SENSITIVE_HUMANITY" = TRAIT_SENSITIVE_HUMANITY,
		...
		"TRAIT_THAUMATURGY_KNOWLEDGE" = TRAIT_THAUMATURGY_KNOWLEDGE,
		...
		"TRAIT_UNAGING" = TRAIT_UNAGING,
		"TRAIT_UNBONDABLE" = TRAIT_UNBONDABLE,
		...
		"TRAIT_VITAE_ADDICTION" = TRAIT_VITAE_ADDICTION,
		"TRAIT_VOICE_MATCHES_ID" = TRAIT_VOICE_MATCHES_ID,
		"TRAIT_VORACIOUS" = TRAIT_VORACIOUS,
		"TRAIT_VTM_CLANS" = TRAIT_VTM_CLANS,
		"TRAIT_WTA_GAROU_AUSPICE" = TRAIT_WTA_GAROU_AUSPICE,
		"TRAIT_WTA_GAROU_BREED" = TRAIT_WTA_GAROU_BREED,
		"TRAIT_WTA_GAROU_TRIBE" = TRAIT_WTA_GAROU_TRIBE,
		"TRAIT_VTM_MORALITY" = TRAIT_VTM_MORALITY,
		...
		"TRAIT_WYRMTAINTED" = TRAIT_WYRMTAINTED,
