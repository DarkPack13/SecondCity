...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_ACUTE_HEARING" = TRAIT_ACUTE_HEARING, // DARKPACK EDIT ADD - MERITS/FLAWS - Physical Merit (Acute Sense)
		"TRAIT_ACUTE_SIGHT" = TRAIT_ACUTE_SIGHT, // DARKPACK EDIT ADD - MERITS/FLAWS - Physical Merit (Acute Sense)
		...
		"TRAIT_BRUISER" = TRAIT_BRUISER, // DARKPACK EDIT ADD - MERITS/FLAWS - Physical Merit
		...
		"TRAIT_DISFIGURED_APPEARANCE" = TRAIT_DISFIGURED_APPEARANCE, // DARKPACK EDIT ADD - MERITS/FLAWS - Physical Flaw
		...
		"TRAIT_ENCHANTING_VOICE" = TRAIT_ENCHANTING_VOICE, // DARKPACK EDIT ADD - MERITS/FLAWS - Physical Merit
		"TRAIT_ENHANCED_MELEE_DODGE" = TRAIT_ENHANCED_MELEE_DODGE, // DARKPACK EDIT ADD
		"TRAIT_EYES_OF_SHADOW" = TRAIT_EYES_OF_SHADOW, // DARKPACK EDIT ADD - MERITS/FLAWS - Physical Merit
		...
		"TRAIT_FRIENDLY_FACE" = TRAIT_FRIENDLY_FACE, // DARKPACK EDIT ADD - MERITS/FLAWS - Physical Merit
		"TRAIT_GHOST_VISION" = TRAIT_GHOST_VISION, // DARKPACK EDIT ADD - POWERS - (Necromancy)
		"TRAIT_GLOWING_EYES" = TRAIT_GLOWING_EYES, // DARKPACK EDIT ADD - MERITS/FLAWS - Physical Flaw
		"TRAIT_GULLET" = TRAIT_GULLET, // DARKPACK EDIT ADD
		"TRAIT_GRAVE_SMELL" = TRAIT_GRAVE_SMELL, // DARKPACK EDIT ADD - MERITS/FLAWS - Physical Flaw
		...
		"TRAIT_HUGE_SIZE" = TRAIT_HUGE_SIZE, // DARKPACK EDIT ADD - MERITS/FLAWS - Physical Merit
		...
		"TRAIT_INFECTIOUS_BITE" = TRAIT_INFECTIOUS_BITE, // DARKPACK EDIT ADD - MERITS/FLAWS - Physical Flaw
		...
		"TRAIT_LAME" = TRAIT_LAME, // DARKPACK EDIT ADD - MERITS/FLAWS - Physical Flaw
		...
		"TRAIT_OPEN_WOUND_CHEST" = TRAIT_OPEN_WOUND_CHEST, // DARKPACK EDIT ADD - MERITS/FLAWS - Physical Flaw - Open Wound
		"TRAIT_OPEN_WOUND_FACE" = TRAIT_OPEN_WOUND_FACE, // DARKPACK EDIT ADD - MERITS/FLAWS - Physical Flaw - Open Wound
		...
		"TRAIT_PREY_EXCLUSION" = TRAIT_PREY_EXCLUSION, // DARKPACK EDIT ADD - MERITS/FLAWS
		...
		"TRAIT_VAMPIRE_TERRITORIAL" = TRAIT_VAMPIRE_TERRITORIAL, // DARKPACK EDIT ADD - MERITS/FLAWS
		"TRAIT_VICTIM_OF_THE_MASQUERADE" = TRAIT_VICTIM_OF_THE_MASQUERADE, // DARKPACK EDIT ADD - MERITS/FLAWS
