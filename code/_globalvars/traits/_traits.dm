...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_COLD_AURA" = TRAIT_COLD_AURA, // DARKPACK EDIT ADD - These are not the only darkpack traits in here, this needs to be fixed next tg pull (so that they are all commented)
