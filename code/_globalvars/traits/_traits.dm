...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/datum/controller/subsystem/processing/station = list(
		...
		"STATION_TRAIT_WILD_MASQUERADE" = STATION_TRAIT_WILD_MASQUERADE, // DARKPACK EDIT ADD START
		"STATION_TRAIT_INFESTATION" = STATION_TRAIT_INFESTATION,
		"STATION_TRAIT_PEST_CONTROL" = STATION_TRAIT_PEST_CONTROL // DARKPACK EDIT ADD END
	),
