...
DEFINE_BITFIELD(turf_flags, list(
	...
	"TURF_BLOCKS_POPULATE_TERRAIN_FLORAFEATURES" = TURF_BLOCKS_POPULATE_TERRAIN_FLORAFEATURES,
...
DEFINE_BITFIELD(disease_flags, list(
	...
	"CHRONIC" = CHRONIC,
	"CURABLE" = CURABLE,
	"INCREMENTAL_CURE" = INCREMENTAL_CURE,
))
...
DEFINE_BITFIELD(item_flags, list(
	...
	"SKIP_FANTASY_ON_SPAWN" = SKIP_FANTASY_ON_SPAWN,
...
DEFINE_BITFIELD(material_flags, list(
	...
	"MATERIAL_NO_EDIBILITY" = MATERIAL_NO_EDIBILITY,
	"MATERIAL_NO_REAGENTS" = MATERIAL_NO_REAGENTS,
	"MATERIAL_NO_DESCRIPTORS" = MATERIAL_NO_DESCRIPTORS,
))
...
DEFINE_BITFIELD(mat_container_flags, list(
	...
	"MATCONTAINER_ACCEPT_ALLOYS" = MATCONTAINER_ACCEPT_ALLOYS,
))
...
DEFINE_BITFIELD(obj_flags, list(
	...
	"MOUNT_ON_LATE_INITIALIZE" = MOUNT_ON_LATE_INITIALIZE,
))
...
DEFINE_BITFIELD(zap_flags, list(
	...
	"ZAP_LOW_POWER_GEN" = ZAP_LOW_POWER_GEN,
))
...
DEFINE_BITFIELD(chemical_flags, list(
	...
	"REAGENT_AFFECTS_WOUNDS" = REAGENT_AFFECTS_WOUNDS,
	"REAGENT_REVERSE_METABOLISM" = REAGENT_REVERSE_METABOLISM,
	"REAGENT_UNAFFECTED_BY_METABOLISM" = REAGENT_UNAFFECTED_BY_METABOLISM,
))
...
DEFINE_BITFIELD(bodytype, list(
	...
	"BODYTYPE_PLANT" = BODYTYPE_PLANT,
	"BODYTYPE_SHADOW" = BODYTYPE_SHADOW,
	"BODYTYPE_GHOST" = BODYTYPE_GHOST,
))
...
DEFINE_BITFIELD(bodyshape, list(
	...
	"BODYSHAPE_GOLEM" = BODYSHAPE_GOLEM,
))
...
DEFINE_BITFIELD(bodypart_flags, list(
	...
	"BODYPART_UNHUSKABLE" = BODYPART_UNHUSKABLE,
	"BODYPART_VIRGIN" = BODYPART_VIRGIN,
	"BODYPART_STUMP" = BODYPART_STUMP,
))
...
DEFINE_BITFIELD(head_flags, list(
	...
	"HEAD_NO_DISFIGURE" = HEAD_NO_DISFIGURE,
))
...
DEFINE_BITFIELD(fish_flags, list(
	...
	"FISH_FLAG_OVERPOPULATED" = FISH_FLAG_OVERPOPULATED,
