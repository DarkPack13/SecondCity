...
// DARKPACK EDIT ADD START
		var/attacker_strengthbrawl = st_get_stat(STAT_STRENGTH) + st_get_stat(STAT_BRAWL)
		var/attacker_dexathletics = st_get_stat(STAT_DEXTERITY) + st_get_stat(STAT_ATHLETICS)
