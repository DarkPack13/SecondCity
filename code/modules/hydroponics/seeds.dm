...
/obj/item/seeds/proc/get_tray_overlay(age, status, tray_offset = 0) // DARKPACK EDIT CHANGE
	...
	plant_overlay.pixel_z = plant_icon_offset + tray_offset // DARKPACK EDIT CHANGE
