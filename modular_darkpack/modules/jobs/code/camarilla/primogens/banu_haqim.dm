...
/datum/outfit/job/vampire/banuprim
	...
	backpack_contents = list(/obj/item/vamp/keys/banuhaqim=1, /obj/item/passport=1, /obj/item/flashlight=1, /obj/item/card/credit/elder=1, /obj/item/card/whip, /obj/item/card/steward, /obj/item/card/myrmidon)
