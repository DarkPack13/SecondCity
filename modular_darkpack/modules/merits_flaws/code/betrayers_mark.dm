/datum/quirk/darkpack/betrayers_mark
	...
	gain_text = span_notice("A mystical 'T' is branded onto your forehead - a mark that you, as a member of Clan Tremere, have undertaken the Vaulderie. Visible only to other Tremere, this mark brands you as Antitribu. While you may re-integrate with the clan, or may even have this mark in spite of your never having done the Vaulderie and always having been loyal, this Mark, which is only visible to other Tremere, makes others of your Clan extremely wary of you.")
