/datum/splat/vampire/ghoul
	name = "Ghoul"
	desc = "Mortals empowered by and addicted to the supernatural blood of Kindred. \
			While not as powerful as true Kindred, they retain their humanity and suffer \
			none of the weaknesses of the Kindred, making them ideal servants to their domitors."
	id = SPLAT_GHOUL
