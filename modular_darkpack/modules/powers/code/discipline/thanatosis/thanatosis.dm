...
/datum/discipline_power/thanatosis/putrefaction/activate(mob/living/target)
	. = ..()
	target.apply_damage(successes * 25) //Adjustment to use proper damage application system for soak and damage modifiers.
...
/datum/discipline_power/thanatosis/necrosis/activate(mob/living/carbon/human/target)
	. = ..()
	target.apply_damage(3 TTRPG_DAMAGE, forced = TRUE) //Adjustment to use proper damage application system for soak and damage modifiers. Unsoakable for sucessful attack here.
