...
/datum/subsplat/werewolf/auspice/garou/philodox
	...
	start_rage = 3
	// gifts_provided= list(/datum/action/cooldown/power/gift/resist_pain, /datum/action/cooldown/power/gift/scent_of_the_true_form, /datum/action/cooldown/power/gift/truth_of_gaia)
...
/datum/subsplat/werewolf/auspice/garou/theurge
	...
	start_rage = 2
	// gifts_provided= list(/datum/action/cooldown/power/gift/mothers_touch, /datum/action/cooldown/power/gift/sense_wyrm, /datum/action/cooldown/power/gift/spirit_speech)
