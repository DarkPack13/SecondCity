/datum/subsplat/auspice/garou
	abstract_type = /datum/subsplat/auspice/garou

/datum/subsplat/auspice/garou/ahroun
	name = AUSPICE_AHROUN
	...
	start_rage = 5
	// gifts = list(/datum/action/cooldown/power/gift/falling_touch, /datum/action/cooldown/power/gift/inspiration, /datum/action/cooldown/power/gift/razor_claws)
	moons_born_under = list(MOON_FULL)

/datum/subsplat/auspice/garou/galliard
	...
	start_rage = 4
	// gifts = list(/datum/action/cooldown/power/gift/beast_speech, /datum/action/cooldown/power/gift/call_of_the_wyld, /datum/action/cooldown/power/gift/mindspeak)
	moons_born_under = list(MOON_WAXING_GIBBOUS, MOON_WANING_GIBBOUS)

/datum/subsplat/auspice/garou/philodox
	...
	start_rage = 3
	// gifts = list(/datum/action/cooldown/power/gift/resist_pain, /datum/action/cooldown/power/gift/scent_of_the_true_form, /datum/action/cooldown/power/gift/truth_of_gaia)
	moons_born_under = list(MOON_FIRST_QUARTER, MOON_LAST_QUARTER)

/datum/subsplat/auspice/garou/theurge
	...
	start_rage = 2
	// gifts = list(/datum/action/cooldown/power/gift/mothers_touch, /datum/action/cooldown/power/gift/sense_wyrm, /datum/action/cooldown/power/gift/spirit_speech)
	moons_born_under = list(MOON_WANING_CRESCENT, MOON_WAXING_CRESENT)

/datum/subsplat/auspice/garou/ragabash
	...
	start_rage = 1
	// gifts = list(/datum/action/cooldown/power/gift/blur_of_the_milky_eye, /datum/action/cooldown/power/gift/open_seal, /datum/action/cooldown/power/gift/infectious_laughter)
	moons_born_under = list(MOON_NEW)

/datum/subsplat/auspice/garou/stolen_moon
	name = AUSPICE_NONE
