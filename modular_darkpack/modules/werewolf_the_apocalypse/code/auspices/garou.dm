...
/datum/auspice/garou/ahroun
	...
	start_rage = 5
	// gifts = list(/datum/action/cooldown/gift/falling_touch, /datum/action/cooldown/gift/inspiration, /datum/action/cooldown/gift/razor_claws)
...
/datum/auspice/garou/galliard
	...
	start_rage = 4
	// gifts = list(/datum/action/cooldown/gift/beast_speech, /datum/action/cooldown/gift/call_of_the_wyld, /datum/action/cooldown/gift/mindspeak)
...
/datum/auspice/garou/philodox
	...
	start_rage = 3
	// gifts = list(/datum/action/cooldown/gift/resist_pain, /datum/action/cooldown/gift/scent_of_the_true_form, /datum/action/cooldown/gift/truth_of_gaia)
...
/datum/auspice/garou/theurge
	...
	start_rage = 2
	// gifts = list(/datum/action/cooldown/gift/mothers_touch, /datum/action/cooldown/gift/sense_wyrm, /datum/action/cooldown/gift/spirit_speech)
...
/datum/auspice/garou/ragabash
	...
	start_rage = 1
	// gifts = list(/datum/action/cooldown/gift/blur_of_the_milky_eye, /datum/action/cooldown/gift/open_seal, /datum/action/cooldown/gift/infectious_laughter)
