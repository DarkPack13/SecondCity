...
/datum/preference/choiced/fera_feature/fur_color/apply_to_human(mob/living/carbon/human/target, value)
	target.dna.features[FEATURE_FERA_FUR_COLOR] = value

/datum/preference/choiced/fera_feature/fur_color/is_accessible(datum/preferences/preferences)
	. = ..()
...
/datum/preference/choiced/fera_feature/fur_color/init_possible_values()
	return assoc_to_keys(GLOB.fera_fur_colors[splat_id])


/datum/preference/choiced/fera_feature/fur_color/garou
	savefile_key = "garou_fur_color"
	splat_id = SPLAT_GAROU


/datum/preference/choiced/fera_feature/fur_color/corax
