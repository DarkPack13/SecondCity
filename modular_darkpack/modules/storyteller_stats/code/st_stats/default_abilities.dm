...
/datum/st_stat/ability/academics/update_mob(mob/living/our_mob, initial)
	...
	if(current_score >= 1)
		our_mob.grant_partial_language(/datum/language/common, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/spanish, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/french, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/german, 25, LANGUAGE_ATOM)

	// level 2 - italian, polish, adds addtl 25 to common spanish french german (-> 50)
	if(current_score >= 2)
		our_mob.grant_partial_language(/datum/language/italian, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/polish, 25, LANGUAGE_ATOM)

		our_mob.grant_partial_language(/datum/language/common, 50, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/spanish, 50, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/french, 50, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/german, 50, LANGUAGE_ATOM)

	// level 3 - czech, tagalog, ukrainian, welsh, armenian, adds addtl 10 to common spanish french german (-> 75)
	if(current_score >= 3)
		our_mob.grant_partial_language(/datum/language/czech, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/tagalog, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/ukrainian, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/welsh, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/armenian, 25, LANGUAGE_ATOM)

		our_mob.grant_partial_language(/datum/language/common, 60, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/spanish, 60, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/french, 60, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/german, 60, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/italian, 40, LANGUAGE_ATOM)

	// level 4 - hebrew, russian, greek
	if(current_score >= 4)
		our_mob.grant_partial_language(/datum/language/hebrew, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/russian, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/greek, 25, LANGUAGE_ATOM)

	// level 5 - japanese, mandarin, latin, farsi, arabic, cantonese, scottish, irish, korean
	if(current_score >= 5)
		our_mob.grant_partial_language(/datum/language/japanese, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/mandarin, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/latin, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/farsi, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/arabic, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/cantonese, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/scottish, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/irish, 25, LANGUAGE_ATOM)
		our_mob.grant_partial_language(/datum/language/korean, 25, LANGUAGE_ATOM)
