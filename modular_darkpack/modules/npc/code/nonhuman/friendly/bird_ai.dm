...
/datum/ai_planning_subtree/find_and_hunt_target/find_shiney
	...
	hunt_targets = list(/obj/item/stack/dollar)
	hunt_range = 10

/datum/ai_behavior/find_hunt_target/find_shiney

/datum/ai_behavior/find_hunt_target/find_shiney/valid_dinner(mob/living/source, obj/item/stack/dollar, radius)
	return can_see(source, dollar, radius)

/datum/ai_behavior/hunt_target/find_shiney
	always_reset_target = TRUE

/datum/ai_behavior/hunt_target/find_shiney/target_caught(mob/living/hunter, obj/item/stack/dollar/food_target)
