/obj/structure/retail/camping
	desc = "A store for camping supplies. Smores not included."
	products_list = list(
		new /datum/data/vending_product("camera film", /obj/item/camera_film),
		...
		new /datum/data/vending_product("binoculars", /obj/item/binoculars),
		new /datum/data/vending_product("camera", /obj/item/camera),
