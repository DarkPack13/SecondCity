/obj/structure/retail/grocery_store
	...
	products_list = list(
		...
		new /datum/data/vending_product("cream", /obj/item/reagent_containers/cup/glass/bottle/juice/cream, 5),
		new /datum/data/vending_product("yoghurt", /obj/item/reagent_containers/condiment/yoghurt, 5),
		new /datum/data/vending_product("vinegar", /obj/item/reagent_containers/condiment/vinegar, 5),
		new /datum/data/vending_product("vegetable oil", /obj/item/reagent_containers/condiment/vegetable_oil, 10),
		new /datum/data/vending_product("quality oil", /obj/item/reagent_containers/condiment/olive_oil, 25),
		new /datum/data/vending_product("peanut butter", /obj/item/reagent_containers/condiment/peanut_butter, 5),
		new /datum/data/vending_product("cherry jelly", /obj/item/reagent_containers/condiment/cherryjelly, 5),
		new /datum/data/vending_product("honey", /obj/item/reagent_containers/condiment/honey, 5),
		...
		new /datum/data/vending_product("cornmeal", /obj/item/reagent_containers/condiment/cornmeal, 3),
