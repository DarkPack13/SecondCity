/obj/structure/retail/grocery_store
	...
	products_list = list(
		...
		new /datum/data/vending_product("chips", /obj/item/food/chip, 5),
		new /datum/data/vending_product("water bottle", /obj/item/reagent_containers/cup/glass/vampirewater, 3),
		new /datum/data/vending_product("soda can", /obj/item/reagent_containers/cup/soda_cans/vampiresoda, 3),
		new /datum/data/vending_product("two liter cola bottle", /obj/item/reagent_containers/cup/glass/vampirecola, 7),
		new /datum/data/vending_product("cola can", /obj/item/reagent_containers/cup/soda_cans/vampirecola, 5),
		new /datum/data/vending_product("summer thaw", /obj/item/reagent_containers/cup/soda_cans/summer_thaw, 5),
		...
		new /datum/data/vending_product("cabbage", /obj/item/food/grown/cabbage,1),
		new /datum/data/vending_product("garlic", /obj/item/food/grown/garlic, 1),
		new /datum/data/vending_product("onion", /obj/item/food/grown/onion, 1),
		new /datum/data/vending_product("parsnip", /obj/item/food/grown/parsnip, 1),
		new /datum/data/vending_product("peas", /obj/item/food/grown/peas, 1),
		new /datum/data/vending_product("corn", /obj/item/food/grown/corn, 1),
		new /datum/data/vending_product("apple", /obj/item/food/grown/apple, 1),
		new /datum/data/vending_product("berries", /obj/item/food/grown/berries, 1),
		new /datum/data/vending_product("banana", /obj/item/food/grown/banana, 1),
		...
		new /datum/data/vending_product("beer bottle", /obj/item/reagent_containers/cup/glass/bottle/beer/vampire, 10),
		new /datum/data/vending_product("blue stripe", /obj/item/reagent_containers/cup/glass/bottle/beer/vampire/blue_stripe, 8),
		...
		new /datum/data/vending_product("mixing bowl", /obj/item/reagent_containers/glass/mixing_bow, 15),
	)
