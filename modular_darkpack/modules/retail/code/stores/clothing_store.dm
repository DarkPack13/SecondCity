/obj/structure/retail/clothing_store
	...
	products_list = list(
		...
		new /datum/data/vending_product("red bandana", /obj/item/clothing/mask/bandana/striped/vampire,	10),
		new /datum/data/vending_product("black bandana", /obj/item/clothing/mask/bandana/skull/vampire,	10),
