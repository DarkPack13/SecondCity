/obj/structure/retail/clothing_store
	...
	products_list = list(
		...
		new /datum/data/vending_product("red picture hat", /obj/item/clothing/head/vampire/picture_hat/red, 30),
		...
		new /datum/data/vending_product("blue clip tie", /obj/item/clothing/neck/vampire/tie/blueclip,	10),
		new /datum/data/vending_product("long blue tie", /obj/item/clothing/neck/vampire/tie/bluelong,	10),
		new /datum/data/vending_product("red clip tie", /obj/item/clothing/neck/vampire/tie/redclip,	10),
		new /datum/data/vending_product("long red tie", /obj/item/clothing/neck/vampire/tie/redlong,	10),
		...
		new /datum/data/vending_product("leather choker", /obj/item/clothing/neck/vampire/choker/collar,	20),
		new /datum/data/vending_product("silver chain choker", /obj/item/clothing/neck/vampire/choker/steel,	20),
		new /datum/data/vending_product("fancy choker", /obj/item/clothing/neck/vampire/choker/leatherg,	20),
