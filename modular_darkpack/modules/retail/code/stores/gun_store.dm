/obj/structure/retail/gun_store
	...
	products_list = list(new /datum/data/vending_product("magnum revolver", /obj/item/gun/ballistic/revolver/darkpack/magnum,	200),
		...
		new	/datum/data/vending_product("5.45 ammo", /obj/item/ammo_box/vampire/c545,	1000),
		new	/datum/data/vending_product(".45 ACP ammo", /obj/item/ammo_box/vampire/c45acp,	2100),
		new /datum/data/vending_product("9mm ammo", /obj/item/ammo_box/vampire/c9mm,	600),
		new /datum/data/vending_product(".44 ammo", /obj/item/ammo_box/vampire/c44,	800),
		new /datum/data/vending_product("5.56 ammo", /obj/item/ammo_box/vampire/c556,	2000),
		new /datum/data/vending_product("shotgun", /obj/item/gun/ballistic/shotgun/vampire, 900),
		new /datum/data/vending_product("12ga shotgun shells, buckshot", /obj/item/ammo_box/vampire/c12g/buck,	400),
