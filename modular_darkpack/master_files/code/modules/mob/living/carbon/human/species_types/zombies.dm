...
/datum/species/human/zombie/check_roundstart_eligible()
	return FALSE

/datum/species/human/zombie/on_species_gain(mob/living/carbon/human/C)
	..()
	C.skin_tone = "albino"
	C.hairstyle = "Bald"
	C.update_body_parts()
...
/datum/species/human/zombie/proc/on_zombie_bitten(datum/source, mob/living/carbon/being_bitten)
	SIGNAL_HANDLER

	if(iszombie(being_bitten))
		return COMPONENT_RESIST_VAMPIRE_KISS

/datum/species/human/zombie/on_species_loss(mob/living/carbon/human/C, datum/species/new_species, pref_load)
	. = ..()
